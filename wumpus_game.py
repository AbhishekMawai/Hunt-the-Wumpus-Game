...
""" Set up the maze...
The Maze constructor takes a list of Rooms.
The Room constructor takes 3 arguments: the room number,
the description of the room, and a list of the room numbers that this Room connects to."""
...
# Creating the Wumpus...
# The Monster constructor takes 1 or 2 arguments. The first
...
# So the Wumpus is now in room 0. We'll move him to a random location later.

# Creating the Player...
"""The Player constructor takes 2 optional arguments: the number
...
# Any Movable object has the .randomly_place() method, which takes
...
while(True):
    ...
    # the .describe_room() method returns a string containing the
    # description of the room with the given number and a list of adjacent
    # rooms.
    ...
    #  All Movables have an .is_near() method that takes another
    ...
    # The Command attribute .command_type is either "move"
    #    or "shoot", depending on the type of the Command.
    # The Command attribute .target is the room number that
    #    the Command is targetting.

    if cmd.command_type == "move":
        # The Movable method .move_to() moves the movable object
        ...
        # The Player method .shoot() takes no arguments. If
